...
<head>
  ...
  <title>SHS - Accountancy, Business, and Management (ABM)</title>
  ...
  <section class="relative min-h-[60vh] flex items-center overflow-hidden">
    ...
    <div class="relative container mx-auto px-4 py-16 text-white">
      <div class="max-w-3xl" data-aos="fade-up">
        ...
        <h1 class="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight mb-4">Accountancy, Business, and Management (ABM)</h1>
        <p class="text-base sm:text-lg text-blue-100 max-w-2xl">Focuses on business, finance, and management fundamentals for students planning to pursue business-related courses in college.</p>
        <div class="mt-6 flex flex-wrap gap-2">
          <span class="chip"><i class="fa-solid fa-chart-pie"></i>Business</span>
          <span class="chip"><i class="fa-solid fa-hand-holding-dollar"></i>Finance</span>
          <span class="chip"><i class="fa-solid fa-users-gear"></i>Management</span>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container mx-auto px-4 grid lg:grid-cols-3 gap-8">
      <div class="lg:col-span-2" data-aos="fade-up">
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-8">
          ...
          <p class="text-gray-700 leading-relaxed">ABM immerses students in core principles of entrepreneurship, marketing, accounting, and organizational management, preparing them for business degrees and careers.</p>
        </div>
      </div>
      <aside data-aos="fade-left">
        <div class="bg-gradient-to-br from-blue-600 to-indigo-700 text-white rounded-2xl shadow-xl p-6">
          <h3 class="text-xl font-semibold mb-2">Why Choose ABM?</h3>
          <p class="text-blue-100 text-sm">Strong foundation for business school and future ventures.</p>
  ...
  <section id="apply" class="py-16 bg-white">
    <div class="container mx-auto px-4" data-aos="fade-up">
      <div class="rounded-2xl p-8 border border-blue-100 bg-gradient-to-r from-blue-50 to-indigo-50 flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
          <h3 class="text-2xl font-bold text-blue-900">Interested in ABM?</h3>
          <p class="text-blue-800 text-sm">Build your path to business leadership.</p>
        </div>
