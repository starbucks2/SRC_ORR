        ...
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-2xl shadow-lg p-6 md:p-8 mb-6">
                ...
                <form method="POST" class="space-y-6 mb-8">
                    ...
                    <div>
                        ...
                        <input type="text" id="fullname" name="fullname" required
                            value="<?php echo htmlspecialchars($admin_data['fullname'] ?? ''); ?>"
                    ...
                    <div class="flex items-center justify-end space-x-4">
                        ...
                        <button type="submit" name="update_profile" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                            Save Changes
                        </button>
                    </div>
                </form>
                ...
                <form method="POST" class="space-y-6">
                    ...
                    <div class="flex items-center justify-end space-x-4">
                        <button type="submit" name="change_password" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                            Update Password
                        </button>
                    </div>
                </form>
