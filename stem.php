...
<head>
  ...
  <title>SHS - Science, Technology, Engineering, and Mathematics (STEM)</title>
  ...
  <section class="relative min-h-[60vh] flex items-center overflow-hidden">
    ...
    <div class="relative container mx-auto px-4 py-16 text-white">
      <div class="max-w-3xl" data-aos="fade-up">
        <p class="uppercase tracking-wider text-blue-200 text-sm mb-2">Senior High School Strand</p>
        <h1 class="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight mb-4">Science, Technology, Engineering, and Mathematics (STEM)</h1>
        <p class="text-base sm:text-lg text-blue-100 max-w-2xl">Strengthens scientific and quantitative foundations for students aiming for STEM-related degrees in college.</p>
        <div class="mt-6 flex flex-wrap gap-2">
          <span class="chip"><i class="fa-solid fa-flask"></i>Science</span>
          <span class="chip"><i class="fa-solid fa-microchip"></i>Technology</span>
          <span class="chip"><i class="fa-solid fa-compass-drafting"></i>Engineering</span>
          <span class="chip"><i class="fa-solid fa-square-root-variable"></i>Mathematics</span>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container mx-auto px-4 grid lg:grid-cols-3 gap-8">
      <div class="lg:col-span-2" data-aos="fade-up">
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-8">
          ...
          <p class="text-gray-700 leading-relaxed">STEM builds strong analytical skills and scientific literacy. Ideal for students planning to pursue engineering, IT, health sciences, or research-oriented courses.</p>
        </div>
      </div>
      <aside data-aos="fade-left">
        <div class="bg-gradient-to-br from-blue-600 to-indigo-700 text-white rounded-2xl shadow-xl p-6">
          <h3 class="text-xl font-semibold mb-2">Why Choose STEM?</h3>
          <p class="text-blue-100 text-sm">Rigorous training in science and math with project-based learning.</p>
  ...
  <section id="apply" class="py-16 bg-white">
    <div class="container mx-auto px-4" data-aos="fade-up">
      <div class="rounded-2xl p-8 border border-blue-100 bg-gradient-to-r from-blue-50 to-indigo-50 flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
          <h3 class="text-2xl font-bold text-blue-900">Interested in STEM?</h3>
          <p class="text-blue-800 text-sm">Set a strong foundation for STEM degrees in college.</p>
        </div>
