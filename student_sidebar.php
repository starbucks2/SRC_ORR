<?php
    ...
    $active_cls = ' bg-blue-primary ring-1 ring-blue-600 border-l-4 border-yellow-300 shadow-md';
    $base_link_cls = 'nav-link flex items-center p-3 rounded-lg transition-all duration-200 hover:bg-blue-primary hover:shadow-md w-full';
...
<!-- Sidebar -->
<aside id="sidebar" class="flex-none w-72 min-w-[18rem] bg-blue-secondary text-white h-screen p-6 fixed lg:static top-0 left-0 z-50 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out sidebar-transition shadow-xl">
    <div class="flex items-center justify-between mb-8 lg:mb-10">
        <div class="flex items-center">
            <img src="srclogo.png" alt="Logo" class="h-20 w-auto mr-3 rounded-full border-2 border-yellow-300">
