...
<head>
  ...
  <title>SHS - Technical-Vocational-Livelihood (TVL)</title>
  ...
  <section class="relative min-h-[60vh] flex items-center overflow-hidden">
    ...
    <div class="relative container mx-auto px-4 py-16 text-white">
      <div class="max-w-3xl" data-aos="fade-up">
        ...
        <h1 class="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight mb-4">Technical-Vocational-Livelihood (TVL)</h1>
        <p class="text-base sm:text-lg text-blue-100 max-w-2xl">Hands-on training for in-demand skills and national certifications to prepare students for employment or entrepreneurship after Senior High School.</p>
        <div class="mt-6 flex flex-wrap gap-2">
          <span class="chip"><i class="fa-solid fa-gears"></i>Technical Skills</span>
          <span class="chip"><i class="fa-solid fa-briefcase"></i>Work Readiness</span>
          <span class="chip"><i class="fa-solid fa-certificate"></i>TESDA Aligned</span>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container mx-auto px-4 grid lg:grid-cols-3 gap-8">
      <div class="lg:col-span-2" data-aos="fade-up">
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-8">
          ...
          <p class="text-gray-700 leading-relaxed">TVL offers specializations such as ICT, Home Economics, and Industrial Arts. Students gain practical competencies and may earn certifications that are recognized by industries.
          </p>
        </div>
      </div>
      <aside data-aos="fade-left">
        <div class="bg-gradient-to-br from-blue-600 to-indigo-700 text-white rounded-2xl shadow-xl p-6">
          <h3 class="text-xl font-semibold mb-2">Why Choose TVL?</h3>
          <p class="text-blue-100 text-sm">Industry-relevant, practical, and certification-ready.</p>
  ...
  <section id="apply" class="py-16 bg-white">
    <div class="container mx-auto px-4" data-aos="fade-up">
      <div class="rounded-2xl p-8 border border-blue-100 bg-gradient-to-r from-blue-50 to-indigo-50 flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
          <h3 class="text-2xl font-bold text-blue-900">Interested in TVL?</h3>
          <p class="text-blue-800 text-sm">Explore skills training and certifications that open doors to work or business.</p>
        </div>
